...
public class CropImage {
	 ...
	 */
	public void cropImage(String sourceFileName, String targetFileName, String targetFileType, int x,
			int y, int w, int h) {
		String sourcePath = sourceDirPath + System.getProperty("file.separator") + sourceFileName;

		try {
			File tempFile = new File(targetDirPath + System.getProperty("file.separator") + targetFileName);
			...
			ImageIO.write(img, targetFileType, tempFile);
			tmp.close();
		} catch (Exception e) {
			e.printStackTrace();
		}
