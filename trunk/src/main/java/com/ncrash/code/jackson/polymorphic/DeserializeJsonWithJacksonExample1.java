...
public class DeserializeJsonWithJacksonExample1 {
	public String SimpleObjectDeserializationAndSerialization()
			throws IOException {
		File jsonFile = new File(getClass().getResource("input_1.json")
				.getFile());
		String jsonInput = FileUtils.readFileToString(jsonFile);

		ObjectMapper mapper = new ObjectMapper();
		AnimalExample1 animal = mapper.readValue(jsonInput,
				AnimalExample1.class);
