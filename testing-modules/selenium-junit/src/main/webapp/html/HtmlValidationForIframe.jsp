...
<h1>Html Validation For Iframe</h1> 

<h3>Validation</h3> 
<ul>
	<li><a href="javascript:htmlValidationStruts();">target iframe validation with struts action</a> - <a href="javascript:alert(getIframeHtmlSource());">view source</a></li>
</ul>
