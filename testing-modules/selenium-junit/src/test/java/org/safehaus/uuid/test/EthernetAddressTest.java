...
public class EthernetAddressTest extends TestCase {
  ...
  private static final String IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_1 = "01f23:45:67:89:ab";
  private static final String IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_2 = "01:23f45:67:89:ab";
  private static final String IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_3 = "01:23:45f67:89:ab";
  private static final String IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_4 = "01:23:45:67f89:ab";
  private static final String IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_5 = "01:23:45:67:89fab";
  private static final String IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_6 = "01f23f45f67f89fab";
  private static final String NON_HEX_ETHERNET_ADDRESS_STRING = "NON-HEX0-FORSURE0";
  private static final String RANDOM_PROPER_LENGTH_STRING = "Same LengthString";

  // some valid strings for the various dropped digit cases
  private static final String FIRST_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING = "00:23:45:67:89:ab";
  private static final String FIRST_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING = "0:23:45:67:89:ab";
  private static final String FIRST_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING = ":23:45:67:89:ab";
  private static final String SECOND_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING = "01:00:45:67:89:ab";
  private static final String SECOND_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING = "01:0:45:67:89:ab";
  private static final String SECOND_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING = "01::45:67:89:ab";
  private static final String THIRD_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING = "01:23:00:67:89:ab";
  private static final String THIRD_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING = "01:23:0:67:89:ab";
  private static final String THIRD_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING = "01:23::67:89:ab";
  private static final String FOURTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING = "01:23:45:00:89:ab";
  private static final String FOURTH_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING = "01:23:45:0:89:ab";
  private static final String FOURTH_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING = "01:23:45::89:ab";
  private static final String FIFTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING = "01:23:45:67:00:ab";
  private static final String FIFTH_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING = "01:23:45:67:0:ab";
  private static final String FIFTH_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING = "01:23:45:67::ab";
  private static final String SIXTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING = "01:23:45:67:89:00";
  private static final String SIXTH_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING = "01:23:45:67:89:0";
  private static final String SIXTH_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING = "01:23:45:67:89:";
  private static final String MIXED_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING = "01:03:00:07:00:00";
  private static final String MIXED_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING = "1:3:0:7:0:0";
  private static final String MIXED_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING = "1:3::7::";

  // here are some sets of good ethernet addresses in various forms
  private static final String NULL_ETHERNET_ADDRESS_STRING = "00:00:00:00:00:00";
  ...
  private static final String UPPER_CASE_VALID_ETHERNET_ADDRESS_STRING = "87:F5:93:06:D3:0C";
  private static final String LOWER_CASE_VALID_ETHERNET_ADDRESS_STRING =
      VALID_ETHERNET_ADDRESS_STRING;
  private static final long VALID_ETHERNET_ADDRESS_LONG = 0x000087f59306d30cL;
   ...
   * tests ***********************************************************************
   */
  /** Test of EthernetAddress(byte[]) constructor, of class org.safehaus.uuid.EthernetAddress. */
  public void testByteArrayEthernetAddressConstructor() {
    // lets test some error cases
    // first, passing null
    try {
      EthernetAddress ethernet_address = new EthernetAddress((byte[]) null);
    ...
    try {
      EthernetAddress ethernet_address =
          new EthernetAddress(new byte[ETHERNET_ADDRESS_ARRAY_LENGTH - 1]);
      // if we reached here we failed because we didn't get an exception
      fail("Expected exception not caught");
    ...
    EthernetAddress ethernet_address = new EthernetAddress(new byte[ETHERNET_ADDRESS_ARRAY_LENGTH]);
    assertEquals(
    ...
    ethernet_address = new EthernetAddress(VALID_ETHERNET_ADDRESS_BYTE_ARRAY);
    assertEquals(
        "EthernetAddress(byte[]) did not create expected EthernetAddress",
  ...
  /** Test of EthernetAddress(long) constructor, of class org.safehaus.uuid.EthernetAddress. */
  public void testLongEthernetAddressConstructor() {
    // let's test that creating a EthernetAddress from an zero long
    // gives us a null EthernetAddress (definition of null EthernetAddress)
    EthernetAddress ethernet_address = new EthernetAddress(0x0000000000000000L);
    assertEquals(
  ...
  /** Test of EthernetAddress(String) constructor, of class org.safehaus.uuid.EthernetAddress. */
  public void testStringEthernetAddressConstructor() {
    // test a null string case
    try {
      EthernetAddress ethernet_address = new EthernetAddress((String) null);
      fail("Expected exception not caught");
    } catch (NullPointerException ex) {
      // this is the success case so do nothing
    } catch (Exception ex) {
    ...
    badStringEthernetAddressConstructorHelper(IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_1);
    badStringEthernetAddressConstructorHelper(IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_2);
    badStringEthernetAddressConstructorHelper(IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_3);
    badStringEthernetAddressConstructorHelper(IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_4);
    badStringEthernetAddressConstructorHelper(IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_5);
    badStringEthernetAddressConstructorHelper(IMPROPER_NUM_COLONS_ETHERNET_ADDRESS_STRING_6);
    badStringEthernetAddressConstructorHelper(NON_HEX_ETHERNET_ADDRESS_STRING);
    badStringEthernetAddressConstructorHelper(RANDOM_PROPER_LENGTH_STRING);

    // some valid strings for the various dropped digit cases
    goodStringEthernetAddressConstructorHelper(
        FIRST_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING, FIRST_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        FIRST_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING, FIRST_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        FIRST_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING, FIRST_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        SECOND_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING, SECOND_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        SECOND_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING, SECOND_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        SECOND_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING, SECOND_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        THIRD_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING, THIRD_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        THIRD_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING, THIRD_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        THIRD_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING, THIRD_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        FOURTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING, FOURTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        FOURTH_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING, FOURTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        FOURTH_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING, FOURTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        FIFTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING, FIFTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        FIFTH_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING, FIFTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        FIFTH_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING, FIFTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        SIXTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING, SIXTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        SIXTH_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING, SIXTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        SIXTH_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING, SIXTH_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        MIXED_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING, MIXED_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        MIXED_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING, MIXED_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        MIXED_GROUP_NO_NUM_ETHERNET_ADDRESS_STRING, MIXED_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING);

    // test the other good cases
    goodStringEthernetAddressConstructorHelper(
        NULL_ETHERNET_ADDRESS_STRING, NULL_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        UPPER_CASE_VALID_ETHERNET_ADDRESS_STRING, UPPER_CASE_VALID_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        LOWER_CASE_VALID_ETHERNET_ADDRESS_STRING, LOWER_CASE_VALID_ETHERNET_ADDRESS_STRING);
    goodStringEthernetAddressConstructorHelper(
        MIXED_CASE_VALID_ETHERNET_ADDRESS_STRING, MIXED_CASE_VALID_ETHERNET_ADDRESS_STRING);
  }
  ...
  public void testAsByteArray() {
    ...
    assertEquals(
        "Expected length of returned array wrong",
        ETHERNET_ADDRESS_ARRAY_LENGTH,
        ethernet_address.asByteArray().length);
    assertEthernetAddressArraysAreEqual(
        NULL_ETHERNET_ADDRESS_BYTE_ARRAY, 0, ethernet_address.asByteArray(), 0);
    ...
    assertEquals(
        ...
        ethernet_address.asByteArray().length);
    assertEthernetAddressArraysAreEqual(
        VALID_ETHERNET_ADDRESS_BYTE_ARRAY, 0, ethernet_address.asByteArray(), 0);
    ...
    assertEthernetAddressArraysAreNotEqual(
        ethernet_address.asByteArray(), 0, ethernet_address_byte_array, 0);
    assertEthernetAddressArraysAreEqual(
        VALID_ETHERNET_ADDRESS_BYTE_ARRAY, 0, ethernet_address.asByteArray(), 0);
  }
  ...
  public void testClone() {
    ...
    assertTrue("x.clone() != x did not return true", x.clone() != x);
    assertTrue(
        "x.clone().getClass() == x.getClass() did not return true",
        x.clone().getClass() == x.getClass());
    assertTrue("x.clone().equals(x) did not return true", x.clone().equals(x));
  }
  ...
  public void testCompareTo() {
    ...
    assertEthernetAddressEqualOrderHelper(NULL_ETHERNET_ADDRESS, new EthernetAddress(0L));

    // 2 of the same value EthernetAddresses are always 0
    assertEthernetAddressEqualOrderHelper(
        MAC0_ETHERNET_ADDRESS, new EthernetAddress(MAC0_ETHERNET_ADDRESS.toLong()));

    // the 'null EthernetAddress' always comes first in the ordering
    assertEthernetAddressGreaterOrderHelper(MAC0_ETHERNET_ADDRESS, NULL_ETHERNET_ADDRESS);

    // EthernetAddresses will always sort
    // with the 'numerically' greater MAC addresses coming later
    assertEthernetAddressGreaterOrderHelper(MAC4_ETHERNET_ADDRESS, MAC0_ETHERNET_ADDRESS);
    assertEthernetAddressGreaterOrderHelper(MAC9_ETHERNET_ADDRESS, MAC4_ETHERNET_ADDRESS);
    assertEthernetAddressGreaterOrderHelper(MAC9_ETHERNET_ADDRESS, MAC0_ETHERNET_ADDRESS);
    ...
    assertEthernetAddressesMatchHelper(NULL_ETHERNET_ADDRESS, ethernet_address_array[0]);
    assertEthernetAddressesMatchHelper(MAC0_ETHERNET_ADDRESS, ethernet_address_array[1]);
    assertEthernetAddressesMatchHelper(MAC0_ETHERNET_ADDRESS, ethernet_address_array[2]);
    assertEthernetAddressesMatchHelper(MAC1_ETHERNET_ADDRESS, ethernet_address_array[3]);
    assertEthernetAddressesMatchHelper(MAC2_ETHERNET_ADDRESS, ethernet_address_array[4]);
    assertEthernetAddressesMatchHelper(MAC3_ETHERNET_ADDRESS, ethernet_address_array[5]);
    assertEthernetAddressesMatchHelper(MAC3_ETHERNET_ADDRESS, ethernet_address_array[6]);
    assertEthernetAddressesMatchHelper(MAC4_ETHERNET_ADDRESS, ethernet_address_array[7]);
    assertEthernetAddressesMatchHelper(MAC4_ETHERNET_ADDRESS, ethernet_address_array[8]);
    assertEthernetAddressesMatchHelper(MAC5_ETHERNET_ADDRESS, ethernet_address_array[9]);
    assertEthernetAddressesMatchHelper(MAC5_ETHERNET_ADDRESS, ethernet_address_array[10]);
    assertEthernetAddressesMatchHelper(MAC6_ETHERNET_ADDRESS, ethernet_address_array[11]);
    assertEthernetAddressesMatchHelper(MAC7_ETHERNET_ADDRESS, ethernet_address_array[12]);
    assertEthernetAddressesMatchHelper(MAC8_ETHERNET_ADDRESS, ethernet_address_array[13]);
    assertEthernetAddressesMatchHelper(MAC9_ETHERNET_ADDRESS, ethernet_address_array[14]);
  }
  ...
  public void testEquals() {
    ...
    EthernetAddress x = new EthernetAddress(VALID_ETHERNET_ADDRESS_BYTE_ARRAY);
    ...
    assertFalse("x.equals(non_EthernetAddress_object) didn't return false", x.equals(new Object()));

    // test a case where two EthernetAddresss are definitly not equal
    EthernetAddress w = new EthernetAddress(ANOTHER_VALID_ETHERNET_ADDRESS_BYTE_ARRAY);
    assertFalse("x == w didn't return false", x == w);
    assertFalse("x.equals(w) didn't return false", x.equals(w));

    // test refelexivity
    assertTrue("x == x didn't return true", x == x);
    assertTrue("x.equals(x) didn't return true", x.equals(x));

    // test symmetry
    EthernetAddress y = new EthernetAddress(VALID_ETHERNET_ADDRESS_BYTE_ARRAY);
    assertFalse("x == y didn't return false", x == y);
    ...
    EthernetAddress z = new EthernetAddress(VALID_ETHERNET_ADDRESS_BYTE_ARRAY);
    assertFalse("x == y didn't return false", x == y);
    assertFalse("x == y didn't return false", y == z);
    assertFalse("x == y didn't return false", x == z);
    assertTrue("x.equals(y) didn't return true", x.equals(y));
  ...
  public void testToByteArray() {
    ...
    assertEthernetAddressArraysAreEqual(
        NULL_ETHERNET_ADDRESS_BYTE_ARRAY, 0, ethernet_address.toByteArray(), 0);
    ...
    assertEquals(
        ...
        ethernet_address.toByteArray().length);
    assertEthernetAddressArraysAreEqual(
        VALID_ETHERNET_ADDRESS_BYTE_ARRAY, 0, ethernet_address.toByteArray(), 0);
    ...
    assertEthernetAddressArraysAreNotEqual(
        ...
        ethernet_address_byte_array, 0);
    assertEthernetAddressArraysAreNotEqual(
        ethernet_address.toByteArray(), 0, ethernet_address_byte_array, 0);
    assertEthernetAddressArraysAreEqual(
        VALID_ETHERNET_ADDRESS_BYTE_ARRAY, 0, ethernet_address.toByteArray(), 0);
  }

  /** Test of toByteArray(byte[]) method, of class org.safehaus.uuid.EthernetAddress. */
  public void testToByteArrayDest() {
    ...
    try {
      EthernetAddress ethernet_address = new EthernetAddress(0L);
      byte[] ethernet_address_byte_array = new byte[ETHERNET_ADDRESS_ARRAY_LENGTH - 1];
    ...
    Arrays.fill(test_array, (byte) 'x');
    ethernet_address.toByteArray(test_array);
    assertEthernetAddressArraysAreEqual(VALID_ETHERNET_ADDRESS_BYTE_ARRAY, 0, test_array, 0);
    ...
    for (int i = 0; i < EXTRA_DATA_LENGTH; i++) {
      assertEquals(
          "Expected array fill value changed",
          (byte) 'x',
  ...
  /** Test of toByteArray(byte[], int) method, of class org.safehaus.uuid.EthernetAddress. */
  public void testToByteArrayDestOffset() {
    ...
    try {
      EthernetAddress ethernet_address = new EthernetAddress(0L);
      byte[] ethernet_address_byte_array = new byte[ETHERNET_ADDRESS_ARRAY_LENGTH];
    ...
    try {
      EthernetAddress ethernet_address = new EthernetAddress(0L);
      byte[] ethernet_address_byte_array = new byte[ETHERNET_ADDRESS_ARRAY_LENGTH];
      ethernet_address.toByteArray(ethernet_address_byte_array, ETHERNET_ADDRESS_ARRAY_LENGTH);
      // if we reached here we failed because we didn't get an exception
      fail("Expected exception not caught");
    } catch (ArrayIndexOutOfBoundsException ex) {
      // this is the success case so do nothing
    ...
    assertEthernetAddressArraysAreEqual(
        NULL_ETHERNET_ADDRESS_BYTE_ARRAY, 0, test_array, EXTRA_DATA_LENGTH / 2);
    for (int i = 0; i < EXTRA_DATA_LENGTH / 2; i++) {
      assertEquals("Expected array fill value changed", (byte) 'x', test_array[i]);
      assertEquals(
          "Expected array fill value changed",
          (byte) 'x',
          test_array[i + ETHERNET_ADDRESS_ARRAY_LENGTH + EXTRA_DATA_LENGTH / 2]);
    }
    ...
    ethernet_address.toByteArray(test_array, EXTRA_DATA_LENGTH / 2);
    assertEthernetAddressArraysAreEqual(
        VALID_ETHERNET_ADDRESS_BYTE_ARRAY, 0, test_array, EXTRA_DATA_LENGTH / 2);
    for (int i = 0; i < EXTRA_DATA_LENGTH / 2; i++) {
      assertEquals("Expected array fill value changed", (byte) 'x', test_array[i]);
      assertEquals(
          "Expected array fill value changed",
  ...
  public void testToLong() {
    ...
    EthernetAddress ethernet_address = new EthernetAddress(0L);
    assertEquals(
        "null EthernetAddress long and toLong did not match",
        NULL_ETHERNET_ADDRESS_LONG,
        ethernet_address.toLong());
    ...
    ethernet_address = new EthernetAddress(VALID_ETHERNET_ADDRESS_BYTE_ARRAY);
    assertEquals(
        "EthernetAddress long and toLong results did not match",
        VALID_ETHERNET_ADDRESS_LONG,
        ethernet_address.toLong());
  }
  ...
  public void testToString() {
    ...
    EthernetAddress ethernet_address = new EthernetAddress(0L);
    assertEquals(
        "null EthernetAddress string and toString did not match",
    ...
    ethernet_address = new EthernetAddress(VALID_ETHERNET_ADDRESS_BYTE_ARRAY);
    assertFalse(
        "mixed case EthernetAddress string and toString "
            + "matched (expected toString to be all lower case)",
        MIXED_CASE_VALID_ETHERNET_ADDRESS_STRING.equals(ethernet_address.toString()));
    assertEquals(
        "mixed case string toLowerCase and "
  ...
  /** Test of valueOf(byte[]) method, of class org.safehaus.uuid.EthernetAddress. */
  public void testValueOfByteArray() {
    // lets test some error cases
    // first, passing null
    try {
      EthernetAddress ethernet_address = EthernetAddress.valueOf((byte[]) null);
      // if we reached here we failed because we didn't get an exception
      fail("Expected exception not caught");
    } catch (NullPointerException ex) {
      // this is the success case so do nothing
    ...
    try {
      EthernetAddress ethernet_address =
          EthernetAddress.valueOf(new byte[ETHERNET_ADDRESS_ARRAY_LENGTH - 1]);
      // if we reached here we failed because we didn't get an exception
      fail("Expected exception not caught");
    } catch (NumberFormatException ex) {
      // this is the success case so do nothing
    ...
    // let's test creating an array from a good byte array
    ethernet_address = EthernetAddress.valueOf(VALID_ETHERNET_ADDRESS_BYTE_ARRAY);
    assertEquals(
        "EthernetAddress.valueOf did not create expected EthernetAddress",
        VALID_ETHERNET_ADDRESS_LONG,
        ethernet_address.toLong());
  ...
  /** Test of valueOf(int[]) method, of class org.safehaus.uuid.EthernetAddress. */
  public void testValueOfIntArray() {
    // lets test some error cases
    // first, passing null
    try {
      EthernetAddress ethernet_address = EthernetAddress.valueOf((int[]) null);
      // if we reached here we failed because we didn't get an exception
      fail("Expected exception not caught");
    } catch (NullPointerException ex) {
      // this is the success case so do nothing
    ...
    try {
      EthernetAddress ethernet_address =
          EthernetAddress.valueOf(new int[ETHERNET_ADDRESS_ARRAY_LENGTH - 1]);
      // if we reached here we failed because we didn't get an exception
      fail("Expected exception not caught");
    } catch (NumberFormatException ex) {
      // this is the success case so do nothing
    ...
    ethernet_address = EthernetAddress.valueOf(VALID_ETHERNET_ADDRESS_INT_ARRAY);
    assertEquals(
        "EthernetAddress.valueOf did not create expected EthernetAddress",
        VALID_ETHERNET_ADDRESS_LONG,
        ethernet_address.toLong());
  ...
  /** Test of valueOf(long) method, of class org.safehaus.uuid.EthernetAddress. */
  public void testValueOfLong() {
    // let's test that creating a EthernetAddress from an zero long
    // gives a null EthernetAddress (definition of a null EthernetAddress)
    EthernetAddress ethernet_address = EthernetAddress.valueOf(0x0000000000000000L);
    assertEquals(
        "EthernetAddress.valueOf did not create expected EthernetAddress",
        NULL_ETHERNET_ADDRESS_LONG,
        ethernet_address.toLong());
    ...
    // let's test creating an array from a good long
    ethernet_address = EthernetAddress.valueOf(VALID_ETHERNET_ADDRESS_LONG);
    assertEquals(
        "EthernetAddress.valueOf did not create expected EthernetAddress",
        VALID_ETHERNET_ADDRESS_LONG,
        ethernet_address.toLong());
  ...
  /** Test of valueOf(String) method, of class org.safehaus.uuid.EthernetAddress. */
  public void testValueOfString() {
    // test a null string case
    try {
      EthernetAddress ethernet_address = EthernetAddress.valueOf((String) null);
      fail("Expected exception not caught");
    } catch (NullPointerException ex) {
      // this is the success case so do nothing
    } catch (Exception ex) {
    ...
    // test the other good cases
    goodStringValueOfHelper(NULL_ETHERNET_ADDRESS_STRING, NULL_ETHERNET_ADDRESS_STRING);
    goodStringValueOfHelper(
        UPPER_CASE_VALID_ETHERNET_ADDRESS_STRING, UPPER_CASE_VALID_ETHERNET_ADDRESS_STRING);
    goodStringValueOfHelper(
        LOWER_CASE_VALID_ETHERNET_ADDRESS_STRING, LOWER_CASE_VALID_ETHERNET_ADDRESS_STRING);
  ...
  /**
   * ************************************************************************ Begin private helper
   * functions for use in tests
   * ***********************************************************************
   */
  private void badStringEthernetAddressConstructorHelper(String ethernetAddressString) {
    try {
      EthernetAddress ethernet_address = new EthernetAddress(ethernetAddressString);
      // if we reached here we failed because we didn't get an exception
      fail("Expected exception not caught");
    } catch (NumberFormatException ex) {
      // this is the success case so do nothing
  ...
  private void goodStringEthernetAddressConstructorHelper(
      String ethernetAddressString, String expectedEthernetAddressString) {
    ...
    assertEquals(
        "EthernetAddresses were not equal",
  ...
  private void badStringValueOfHelper(String ethernetAddressString) {
    try {
      EthernetAddress ethernet_address = EthernetAddress.valueOf(ethernetAddressString);
      // if we reached here we failed because we didn't get an exception
      fail("Expected exception not caught");
    } catch (NumberFormatException ex) {
      // this is the success case so do nothing
  ...
  private void goodStringValueOfHelper(
      String ethernetAddressString, String expectedEthernetAddressString) {
    EthernetAddress ethernet_address = null;
    try {
  ...
  private void assertEthernetAddressesMatchHelper(
      EthernetAddress expected, EthernetAddress actual) {
    assertEquals(
        "EthernetAddresses in long form did not match", expected.toLong(), actual.toLong());
    assertEquals("EthernetAddress equals did not match", expected, actual);
  }

  private void assertEthernetAddressEqualOrderHelper(
      EthernetAddress ethernetAddress1, EthernetAddress ethernetAddress2) {
    assertTrue(
        ethernetAddress1 + " did not test as equal to " + ethernetAddress2,
        0 == ethernetAddress1.compareTo(ethernetAddress2));
    assertTrue(
        ethernetAddress2 + " did not test as equal to " + ethernetAddress1,
  ...
  private void assertEthernetAddressGreaterOrderHelper(
      EthernetAddress ethernetAddress1, EthernetAddress ethernetAddress2) {
    assertTrue(
        ethernetAddress1 + " did not test as larger then " + ethernetAddress2,
        0 < ethernetAddress1.compareTo(ethernetAddress2));
    assertTrue(
        ethernetAddress2 + " did not test as smaller then " + ethernetAddress1,
        0 > ethernetAddress2.compareTo(ethernetAddress1));
  }

  private void assertEthernetAddressArraysAreEqual(
      byte[] array1, int array1_start, byte[] array2, int array2_start) {
    assertTrue("Array1 start offset is invalid", 0 <= array1_start);
    assertTrue("Array2 start offset is invalid", 0 <= array2_start);
    assertTrue(
        "Array1 is not long enough for the given start offset",
        array1.length >= ETHERNET_ADDRESS_ARRAY_LENGTH + array1_start);
    assertTrue(
        "Array2 is not long enough for the given start offset",
        array2.length >= ETHERNET_ADDRESS_ARRAY_LENGTH + array2_start);
    for (int i = 0; i < ETHERNET_ADDRESS_ARRAY_LENGTH; i++) {
      assertEquals(
          "Array1 and Array2 did not match", array1[i + array1_start], array2[i + array2_start]);
    }
  }

  private void assertEthernetAddressArraysAreNotEqual(
      byte[] array1, int array1_start, byte[] array2, int array2_start) {
    assertTrue("Array1 start offset is invalid", 0 <= array1_start);
    assertTrue("Array2 start offset is invalid", 0 <= array2_start);
    assertTrue(
