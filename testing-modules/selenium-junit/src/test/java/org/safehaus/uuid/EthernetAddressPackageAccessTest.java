...
/**
 * JUnit Test class for checking the package access methods of the org.safehaus.uuid.EthernetAddress
 * class.
 *
 * @author Eric Bie
 */
public class EthernetAddressPackageAccessTest extends TestCase {
  ...
  public static Test suite() {
    TestSuite suite = new TestSuite(EthernetAddressPackageAccessTest.class);
    return suite;
  }
   ...
   * tests ***********************************************************************
   */
  /** Test of EthernetAddress() constructor, of class org.safehaus.uuid.EthernetAddress. */
