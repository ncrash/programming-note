...
public class UUIDGeneratorTest extends TestCase {
  ...
  public void testGetInstance() {
    ...
    assertTrue("uuid_gen1 == uuid_gen2 was not true", uuid_gen1 == uuid_gen2);
    assertTrue("uuid_gen2 == uuid_gen3 was not true", uuid_gen2 == uuid_gen3);
    assertTrue("uuid_gen1 == uuid_gen3 was not true", uuid_gen1 == uuid_gen3);
  }

  /** Test of getDummyAddress method, of class org.safehaus.uuid.UUIDGenerator. */
  public void testGetDummyAddress() {
    ...
    for (int i = 0; i < ethernet_address_array.length; i++) {
      ...
      assertFalse(
          ...
          Arrays.equals(null_ethernet_address.asByteArray(), ethernet_address));
  ...
  /** Test of getRandomNumberGenerator method, of class org.safehaus.uuid.UUIDGenerator. */
  public void testGetRandomNumberGenerator() {
    ...
    assertTrue("secure_rand1 == secure_rand2 was not true", secure_rand1 == secure_rand2);
    assertTrue("secure_rand2 == secure_rand3 was not true", secure_rand2 == secure_rand3);
    assertTrue("secure_rand3 == secure_rand4 was not true", secure_rand3 == secure_rand4);
    assertTrue("secure_rand4 == secure_rand5 was not true", secure_rand4 == secure_rand5);
    assertTrue("secure_rand5 == secure_rand6 was not true", secure_rand5 == secure_rand6);
    assertTrue("secure_rand6 == secure_rand1 was not true", secure_rand6 == secure_rand1);
  }

  /** Test of getHashAlgorithm method, of class org.safehaus.uuid.UUIDGenerator. */
  public void testGetHashAlgorithm() {
    ...
    assertTrue(
        "message_digest1 == message_digest2 was not true", message_digest1 == message_digest2);
    assertTrue(
        "message_digest2 == message_digest3 was not true", message_digest2 == message_digest3);
    assertTrue(
        "message_digest3 == message_digest4 was not true", message_digest3 == message_digest4);
    assertTrue(
        "message_digest4 == message_digest5 was not true", message_digest4 == message_digest5);
    assertTrue(
        "message_digest5 == message_digest6 was not true", message_digest5 == message_digest6);
    assertTrue(
        "message_digest6 == message_digest1 was not true", message_digest6 == message_digest1);
  }

  /** Test of generateRandomBasedUUID method, of class org.safehaus.uuid.UUIDGenerator. */
  public void testGenerateRandomBasedUUID() {
    ...
    checkUUIDArrayForCorrectVariantAndVersion(uuid_array, UUID.TYPE_RANDOM_BASED);
  ...
  /** Test of generateRandomBasedUUID(Random) method, of class org.safehaus.uuid.UUIDGenerator. */
  ...
  /** Test of generateTimeBasedUUID() method, of class org.safehaus.uuid.UUIDGenerator. */
  public void testGenerateTimeBasedUUID() {
    ...
    checkUUIDArrayForCorrectVariantAndVersion(uuid_array, UUID.TYPE_TIME_BASED);
  ...
  /**
   * Test of generateTimeBasedUUID(EthernetAddress) method, of class
  ...
  /**
   * Test of generateNameBasedUUID(UUID, String) method, of class org.safehaus.uuid.UUIDGenerator.
   */
  public void testGenerateNameBasedUUIDNameSpaceAndName() {
    ...
    // first, check that a null passed in causes the appropriate exception
    try {
      UUID uuid = uuid_gen.generateNameBasedUUID(NAMESPACE_UUID, (String) null);
      fail("Expected exception not thrown");
    } catch (NullPointerException ex) {
      // expected exception caught, do nothing
    } catch (Exception ex) {
    ...
    // now create the array of uuids
    for (int i = 0; i < uuid_array.length; i++) {
      uuid_array[i] = uuid_gen.generateNameBasedUUID(NAMESPACE_UUID, "test name" + i);
    }
    ...
    checkUUIDArrayForCorrectVariantAndVersion(uuid_array, UUID.TYPE_NAME_BASED);
    ...
    // now create the array of uuids
    for (int i = 0; i < uuid_array.length; i++) {
      uuid_array[i] = uuid_gen.generateNameBasedUUID(null, "test name" + i);
    }
    ...
    for (int i = 0; i < uuid_array2.length; i++) {
      uuid_array2[i] = uuid_gen.generateNameBasedUUID(NAMESPACE_UUID, "test name" + i);
    }
    ...
    assertTrue(
        "expected both arrays to be equal, they were not!", Arrays.equals(uuid_array, uuid_array2));
  }

  /**
   * Test of generateNameBasedUUID(UUID, String, MessageDigest) method, of class
   * org.safehaus.uuid.UUIDGenerator.
   */
  public void testGenerateNameBasedUUIDNameSpaceNameAndMessageDigest() {
    ...
    // first, check that a null passed in causes the appropriate exception
    try {
      UUID uuid = uuid_gen.generateNameBasedUUID(NAMESPACE_UUID, (String) null, MESSAGE_DIGEST);
      fail("Expected exception not thrown");
    } catch (NullPointerException ex) {
      // expected exception caught, do nothing
    } catch (Exception ex) {
    ...
    try {
      UUID uuid = uuid_gen.generateNameBasedUUID(NAMESPACE_UUID, "test name", (MessageDigest) null);
      fail("Expected exception not thrown");
    } catch (NullPointerException ex) {
      // expected exception caught, do nothing
    } catch (Exception ex) {
    ...
    try {
      UUID uuid =
          uuid_gen.generateNameBasedUUID(NAMESPACE_UUID, (String) null, (MessageDigest) null);
      fail("Expected exception not thrown");
    } catch (NullPointerException ex) {
      // expected exception caught, do nothing
    } catch (Exception ex) {
    ...
    for (int i = 0; i < uuid_array.length; i++) {
      uuid_array[i] =
          uuid_gen.generateNameBasedUUID(NAMESPACE_UUID, "test name" + i, MESSAGE_DIGEST);
    }
    ...
    // now create the array of uuids
    for (int i = 0; i < uuid_array.length; i++) {
      uuid_array[i] = uuid_gen.generateNameBasedUUID(null, "test name" + i, MESSAGE_DIGEST);
    }
  ...
  /** Test of generateTagURIBasedUUID(TagURI) method, of class org.safehaus.uuid.UUIDGenerator. */
  public void testGenerateTagURIBasedUUID() {
    ...
    for (int i = 0; i < uuid_array.length; i++) {
      ...
      uuid_array[i] = uuid_gen.generateTagURIBasedUUID(test_tag);
    }
    ...
    for (int i = 0; i < uuid_array.length; i++) {
      TagURI test_tag = new TagURI(TEST_AUTHORITY, "test id" + i, Calendar.getInstance());
      uuid_array[i] = uuid_gen.generateTagURIBasedUUID(test_tag);
      uuid_array2[i] = uuid_gen.generateTagURIBasedUUID(test_tag);
    }
  ...
  /**
   * Test of generateTagURIBasedUUID(TagURI, MessageDigest) method, of class
   * org.safehaus.uuid.UUIDGenerator.
   */
  public void testGenerateTagURIBasedUUIDWithMessageDigest() {
    ...
    try {
      TagURI test_tag = new TagURI(TEST_AUTHORITY, "test id", Calendar.getInstance());
    ...
    for (int i = 0; i < uuid_array.length; i++) {
      TagURI test_tag = new TagURI(TEST_AUTHORITY, "test id" + i, Calendar.getInstance());
      uuid_array[i] = uuid_gen.generateTagURIBasedUUID(test_tag, MESSAGE_DIGEST);
      uuid_array2[i] = uuid_gen.generateTagURIBasedUUID(test_tag, MESSAGE_DIGEST);
    }
  ...
  private void checkUUIDArrayForCorrectOrdering(UUID[] uuidArray) {
    ...
    for (int i = 0; i < uuid_sorted_array.length; i++) {
      assertTrue(
          ...
          uuidArray[i].equals(uuid_sorted_array[uuid_sorted_array.length - (1 + i)]));
    }
  ...
  private void checkUUIDArrayForUniqueness(UUID[] uuidArray) {
    ...
    for (int i = 0; i < uuidArray.length; i++) {
      assertTrue("Uniqueness test failed on insert into HashSet", hash_set.add(uuidArray[i]));
      assertFalse("Paranoia Uniqueness test failed (second insert)", hash_set.add(uuidArray[i]));
    }
  }

  private void checkUUIDArrayForCorrectVariantAndVersion(UUID[] uuidArray, int expectedType) {
    // let's check that all the UUIDs are valid type-1 UUIDs with the
    // correct variant according to the specification.
    for (int i = 0; i < uuidArray.length; i++) {
      assertEquals("Expected version (type) did not match", expectedType, uuidArray[i].getType());
      ...
      assertEquals("Expected type did not match", expectedType, type);
  ...
  private void checkUUIDArrayForCorrectCreationTime(
    ...
    for (int i = 0; i < uuidArray.length; i++) {
      ...
      assertTrue(
          ...
          startTime <= uuid_time);
      assertTrue(
          "UUID timestamp: " + uuid_time + " was not before the start time: " + endTime,
          uuid_time <= endTime);
    }
  }

  private void checkUUIDArrayForCorrectEthernetAddress(
      UUID[] uuidArray, EthernetAddress ethernetAddress) {
    for (int i = 0; i < uuidArray.length; i++) {
      byte[] uuid_ethernet_address = new byte[6];
      System.arraycopy(uuidArray[i].toByteArray(), 10, uuid_ethernet_address, 0, 6);
  ...
  private void checkUUIDArrayForNonNullUUIDs(UUID[] uuidArray) {
    for (int i = 0; i < uuidArray.length; i++) {
      assertFalse("UUID was null", uuidArray[i].isNullUUID());
    }
  }
  /**
   * ************************************************************************ End Private Helper
