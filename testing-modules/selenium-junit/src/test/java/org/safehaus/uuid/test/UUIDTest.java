 ...
 *
 * <p>The UUIDTest class is in a different sub-package to make sure 'public' methods are correctly
 * accessable.
 *
 * @author Eric Bie
 */
public class UUIDTest extends TestCase {
  ...
  public void testDefaultUUIDConstructor() {
    ...
    UUID uuid = new UUID();
    assertEquals(
        "Default constructor did not create expected null UUID", NULL_UUID_STRING, uuid.toString());
    assertTrue(
        "Expected array did not equal actual array",
  ...
  public void testByteArrayUUIDConstructor() {
    ...
    assertEquals(
        "constructor did not create expected null UUID", NULL_UUID_STRING, uuid.toString());
    assertTrue(
        "Expected array did not equal actual array",
        Arrays.equals(NULL_UUID_BYTE_ARRAY, uuid.toByteArray()));
  ...
  public void testByteArrayFromOffsetUUIDConstructor() {
    ...
    try {
      UUID uuid = new UUID(new byte[UUID_BYTE_ARRAY_LENGTH], UUID_BYTE_ARRAY_LENGTH);
      fail("Expected exception not caught");
    } catch (ArrayIndexOutOfBoundsException ex) {
      // this is the success case so do nothing
    } catch (Exception ex) {
    ...
    byte[] null_uuid_array = new byte[UUID_BYTE_ARRAY_LENGTH + EXTRA_DATA_LENGTH];
    ...
    assertEquals(
        "constructor did not create expected null UUID",
        MIXED_CASE_VALID_UUID_STRING.toLowerCase(),
        uuid.toString().toLowerCase());
  ...
  public void testAsByteArray() {
    ...
    assertFalse(
        "Expected array was equal other array",
        Arrays.equals(VALID_UUID_BYTE_ARRAY, test_uuid_array));
    assertFalse(
        "Expected array was equal other array", Arrays.equals(uuid.asByteArray(), test_uuid_array));
    assertTrue(
        "Expected array did not equal actual array",
        Arrays.equals(VALID_UUID_BYTE_ARRAY, uuid.asByteArray()));
  }
  ...
  public void testCompareTo() {
    ...
    assertUUIDEqualOrderHelper(TIME3_MAC1_UUID, new UUID(TIME3_MAC1_UUID.toString()));
  ...
  public void testGetNullUUID() {
    ...
    assertEquals(
        "getNullUUID did not create expected null UUID", NULL_UUID_STRING, uuid.toString());
    assertTrue(
        "Expected array did not equal actual array",
        Arrays.equals(NULL_UUID_BYTE_ARRAY, uuid.toByteArray()));
    ...
    assertEquals(
        "getNullUUID did not create expected null UUID", NULL_UUID_STRING, uuid2.toString());
    assertTrue(
        "Expected array did not equal actual array",
        Arrays.equals(NULL_UUID_BYTE_ARRAY, uuid2.toByteArray()));
    assertTrue("two returned null UUIDs were not the sam object instance", uuid == uuid2);
  }
  ...
  public void testGetType() {
    ...
    assertTrue(
        "Expected array did not equal actual array",
        Arrays.equals(NULL_UUID_BYTE_ARRAY, uuid.toByteArray()));
    assertEquals("Expected type was not returned", UUID.TYPE_NULL, uuid.getType());
    ...
    assertEquals("Expected type was not returned", UUID.TYPE_RANDOM_BASED, uuid.getType());
    ...
    assertEquals(
        ...
        uuid.toString().toLowerCase());
    assertEquals("Expected type was not returned", UUID.TYPE_TIME_BASED, uuid.getType());
    ...
    assertEquals("Expected type was not returned", UUID.TYPE_NAME_BASED, uuid.getType());
    ...
    assertEquals("Expected type was not returned", UUID.TYPE_DCE, uuid.getType());
  }
  ...
  public void testHashCode() {
    ...
    assertTrue("x == x didn't return true", x == x);
    assertTrue("x.equals(x) didn't return true", x.equals(x));
    assertEquals("x.hashCode() didn't equal x.hashCode()", x.hashCode(), x.hashCode());
    assertEquals("x.hashCode() didn't equal x.hashCode()", x.hashCode(), x.hashCode());
    ...
    assertFalse("x == y didn't return false", x == y);
    assertTrue("x.equals(y) didn't return true", x.equals(y));
    assertEquals("x.hashCode() didn't equal y.hashCode()", x.hashCode(), y.hashCode());
  ...
  public void testIsNullUUID() {
    ...
    uuid = new UUID();
    assertTrue("isNullUUID was not true", uuid.isNullUUID());
    ...
    uuid = new UUID(VALID_UUID_BYTE_ARRAY);
    assertFalse("isNullUUID was true", uuid.isNullUUID());
  }
  ...
  public void testSetDescCaching() {
    ...
    assertFalse("x == y was not false", x == y);
    assertEquals("x.equals(y) was not true", x, y);

    uuid.setDescCaching(true);
    String a = uuid.toString();
    String b = uuid.toString();
    assertTrue("a == b was not true", a == b);
    assertEquals("a.equals(b) was not true", a, b);
    assertFalse("y == a was not false", y == a);
    assertEquals("y.equals(a) was not true", y, a);
  }
  ...
  public void testToByteArray() {
    ...
    assertFalse(
        ...
        Arrays.equals(VALID_UUID_BYTE_ARRAY, test_uuid_array));
    assertFalse(
        "Expected array was equal other array", Arrays.equals(uuid.toByteArray(), test_uuid_array));
    assertTrue(
        "Expected array did not equal actual array",
        Arrays.equals(VALID_UUID_BYTE_ARRAY, uuid.toByteArray()));
  }
  ...
  public void testToByteArrayDest() {
    ...
    for (int i = 0; i < UUID_BYTE_ARRAY_LENGTH; ++i) {
      assertEquals("Expected array values did not match", NULL_UUID_BYTE_ARRAY[i], test_array[i]);
    }
    for (int i = 0; i < EXTRA_DATA_LENGTH; i++) {
      assertEquals(
          "Expected array fill value changed", (byte) 'x', test_array[i + UUID_BYTE_ARRAY_LENGTH]);
    }
    ...
    test_uuid.toByteArray(test_array);
    for (int i = 0; i < UUID_BYTE_ARRAY_LENGTH; ++i) {
      assertEquals("Expected array values did not match", VALID_UUID_BYTE_ARRAY[i], test_array[i]);
    }
    for (int i = 0; i < EXTRA_DATA_LENGTH; i++) {
      assertEquals(
          "Expected array fill value changed", (byte) 'x', test_array[i + UUID_BYTE_ARRAY_LENGTH]);
  ...
  /** Test of toByteArray(byte[], int) method, of class org.safehaus.uuid.UUID. */
  public void testToByteArrayDestOffset() {
    ...
    for (int i = 0; i < UUID_BYTE_ARRAY_LENGTH; ++i) {
      assertEquals(
          "Expected array values did not match",
  ...
  public void testToString() {
    ...
    UUID uuid = new UUID();
    assertEquals(
        "null uuid string and toString did not match",
    ...
    uuid = new UUID(VALID_UUID_BYTE_ARRAY);
    assertEquals(
        "uuid string and toString results did not match",
        MIXED_CASE_VALID_UUID_STRING.toLowerCase(),
        uuid.toString().toLowerCase());
    ...
    uuid = new UUID(VALID_UUID_BYTE_ARRAY);
    assertFalse(
        "mixed case uuid string and toString " + "matched (expected toString to be all lower case)",
  ...
  public void testValueOfByteArray() {
    ...
    assertEquals(
        "UUID.valueOf did not create expected null UUID",
        NULL_UUID_STRING.toLowerCase(),
  ...
  public void testValueOfByteArrayFromOffset() {
    ...
    // now an index that is too big
    try {
      UUID uuid = UUID.valueOf(new byte[UUID_BYTE_ARRAY_LENGTH], UUID_BYTE_ARRAY_LENGTH);
  ...
  private void assertUUIDsMatchHelper(UUID expected, UUID actual) {
    ...
    assertEquals(
        "UUID strings did not match",
        expected.toString().toLowerCase(),
        actual.toString().toLowerCase());

    assertEquals("UUID equals did not match", expected, actual);
  }

  private void assertUUIDEqualOrderHelper(UUID uuid1, UUID uuid2) {
    assertTrue(uuid1 + " did not test as equal to " + uuid2, 0 == uuid1.compareTo(uuid2));
    assertTrue(uuid2 + " did not test as equal to " + uuid1, 0 == uuid2.compareTo(uuid1));
  }

  private void assertUUIDGreaterOrderHelper(UUID uuid1, UUID uuid2) {
    assertTrue(uuid1 + " did not test as larger then " + uuid2, 0 < uuid1.compareTo(uuid2));
    assertTrue(uuid2 + " did not test as smaller then " + uuid1, 0 > uuid2.compareTo(uuid1));
  }
  /**
   * ************************************************************************ End private helper
   * functions for use in tests
  ...
  private static final String NON_HEX_UUID_STRING = "01THISIS-ANON-HEX0-UUID-FORSURE01234";
  private static final String RANDOM_PROPER_LENGTH_STRING = "String Of The Same Length as a UUID!";
  ...
  private static final UUID TIME1_MAC1_UUID = new UUID("ebb8e8fe-b1b1-11d7-8adb-00b0d078fa18");
  private static final UUID TIME1_MAC2_UUID = new UUID("ebb8e8fe-b1b1-11d7-8adb-baa07db6d227");
  private static final UUID TIME2_MAC1_UUID = new UUID("ec3ffdda-b1b1-11d7-8adb-00b0d078fa18");
  private static final UUID TIME2_MAC2_UUID = new UUID("ec3ffdda-b1b1-11d7-8adb-baa07db6d227");
  private static final UUID TIME3_MAC1_UUID = new UUID("eca4c616-b1b1-11d7-8adb-00b0d078fa18");
  private static final UUID TIME3_MAC2_UUID = new UUID("eca4c616-b1b1-11d7-8adb-baa07db6d227");
  private static final UUID TIME4_MAC1_UUID = new UUID("ed17de08-b1b1-11d7-8adb-00b0d078fa18");
  private static final UUID TIME4_MAC2_UUID = new UUID("ed17de08-b1b1-11d7-8adb-baa07db6d227");
  private static final UUID TIME5_MAC1_UUID = new UUID("ed94244a-b1b1-11d7-8adb-00b0d078fa18");
  private static final UUID TIME5_MAC2_UUID = new UUID("ed94244a-b1b1-11d7-8adb-baa07db6d227");
  /**
