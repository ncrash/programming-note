...
//		File rolloverImageFile =
//			new File(getClass().getClassLoader().getResource("Layer-Flash.png").getFile());
//
//		String rolloverImageFileName = rolloverImageFile.getCanonicalPath();
//		String rolloverImageCropFileName =
//			rolloverImageFile.getParent()
//				+ System.getProperty("file.separator")
//				+ "Layer-Flash-Crop.png";
//		String rolloverImageCropThumbnailJavaxFileName =
//			rolloverImageFile.getParent()
//				+ System.getProperty("file.separator")
//				+ "Layer-Flash-Thumb-JAVAX.png";
//		String rolloverImageCropThumbnailJimiFileName =
//			rolloverImageFile.getParent()
//				+ System.getProperty("file.separator")
//				+ "Layer-Flash-Thumb-JIMI.png";
...
//		cropImageInstance.cropImage(
//			rolloverImageFileName, rolloverImageCropFileName, "png", 120, 0, 120, 90);
//
//		/*
...
//	//		cropImageInstance.cropImage("Layer-Flash.png", "Layer-Flash-Crop.png", "png", 120, 0, 120,
//	// 90);
//	//	}
//	//
//	//	@Test
...
//	//		ThumbnailGenerator tg = new ThumbnailGenerator();
//	//		tg.transform("d:\\temp\\crop\\Layer-Flash-Crop.png",
//	// "d:\\temp\\crop\\Layer-Flash-Thumb-JAVAX.png", 56, 56, 1);
//	//	}
//	//
//	//	@Test
//	//	public void testThumbnailImageWithJimi() throws Exception {
//	//        Image thumbnail = JimiUtils.getThumbnail("d:\\temp\\crop\\Layer-Flash-Crop.png", 56, 56,
//	// Jimi.IN_MEMORY);
//	//
//	//        try {
