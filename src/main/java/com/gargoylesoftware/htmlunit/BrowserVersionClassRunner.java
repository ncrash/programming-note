...
class BrowserVersionClassRunner extends BlockJUnit4ClassRunner {
  ...
  public BrowserVersionClassRunner(
      final Class<WebTestCase> klass,
      final BrowserVersion browserVersion,
      final boolean useWebDriver)
  ...
  /**
   * Returns true if current {@link #browserVersion_} is contained in the specific
   * <tt>browsers</tt>.
   */
