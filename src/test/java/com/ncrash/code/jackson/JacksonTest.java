...
//		assertEquals("Rm9vYmFyIQ==", user.getUserImage());
	...
	@Test
	public void testSimpleDataBindingExample() throws JsonParseException, JsonMappingException, IOException {
	...
	@Ignore
	@Test
	public void testDataBindingWithGenerics() throws JsonParseException, JsonMappingException, IOException {
...
//		m.writeValue(new File("user-modified.json"), rootNode);
	...
	@Test
	public void testStreamingAPIExample() throws JsonParseException,
			IOException {
