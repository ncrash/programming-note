...
public class DeserializeJsonWithJacksonTest {
  ...
  public void example1() throws Exception {
    ...
    assertEquals(
        metadatacontent,
        deserializeJsonWithJacksonExample1.SimpleObjectDeserializationAndSerialization());
  }
  ...
  public void example2() throws Exception {
    ...
    assertEquals(
        metadatacontent,
        deserializeJsonWithJacksonExample2.SimpleCollectionDeserializationAndSerialization(
            "TypeReference"));
    assertEquals(
        metadatacontent,
        deserializeJsonWithJacksonExample2.SimpleCollectionDeserializationAndSerialization(
  ...
  public void example3() throws Exception {
    ...
    assertEquals(
        metadatacontent,
        deserializeJsonWithJacksonExample3
            .SimpleDeserializationSerializationToFromContainerObjectWithCollection());
  }
  ...
  public void example4() throws Exception {
    ...
    assertEquals(
        metadatacontent,
        deserializeJsonWithJacksonExample4
            .SimpleDeserializationSerializationToFromContainerObjectWithPolymorphicCollection());
  }
  ...
  public void example5() throws Exception {
    ...
    assertEquals(
        metadatacontent,
        deserializeJsonWithJacksonExample5
            .SimpleDeserializationSerializationWithMixInToFromContainerObjectWithPolymorphicCollection());
  }
  ...
  public void example6() throws Exception {
    ...
    assertEquals(
        metadatacontent,
        deserializeJsonWithJacksonExample6
            .SimpleDeserializationWithoutTypeElementToContainerObjectWithPolymorphicCollection());
  }
}
